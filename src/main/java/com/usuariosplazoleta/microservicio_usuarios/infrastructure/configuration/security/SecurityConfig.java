...
import static com.usuariosplazoleta.microservicio_usuarios.domain.util.Constantes.ROLE_ADMIN;
    ...
    SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(reg -> reg
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/users/saveUser").hasAnyRole(ROLE_ADMIN)
                        .requestMatchers(HttpMethod.POST, "/api/v1/users/saveUserEmployee").hasAnyRole(ROLE_OWNER)
                        .requestMatchers(HttpMethod.POST, "/api/v1/users/saveClients").permitAll()
